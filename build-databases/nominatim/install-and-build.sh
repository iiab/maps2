...
# Copy these each time in case we change them as we develop
sudo cp nominatim-setup.sh.prep $USERHOME/nominatim-setup.sh
sudo chown $USERNAME:$USERNAME $USERHOME/nominatim-setup.sh
sudo chmod u+x $USERHOME/nominatim-setup.sh
